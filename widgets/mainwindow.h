...
private:
  ...
  QSet<QString> m_hralMembers;          //IOTA-HRAL paid-member base callsigns (uppercased, prefix/suffix stripped)
  QFileSystemWatcher m_hralFileWatcher;
  ...
  void houndCallers();
  void loadHralMembers();
  void updateHralCheckboxState();
  bool hralFilterActive() const;
